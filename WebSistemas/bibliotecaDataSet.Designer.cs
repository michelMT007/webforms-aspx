...
namespace WebSistemas {
    ...
    public partial class bibliotecaDataSet : global::System.Data.DataSet {
        ...
        public partial class LivroDataTable : global::System.Data.TypedTableBase<LivroRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public LivroRow AddLivroRow(string Titulo, string Genero, string Autor, string Sinopse, string Capa) {
            ...
            private void InitClass() {
                ...
                this.columnSinopse.AllowDBNull = false;
                this.columnSinopse.MaxLength = 300;
                this.columnCapa.AllowDBNull = false;
                this.columnCapa.MaxLength = 250;
            }
...
namespace WebSistemas.bibliotecaDataSetTableAdapters {
    ...
    public partial class LivroTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Livro] WHERE (([id] = @Original_id))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_id", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "id", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Livro] ([Titulo], [Genero], [Autor], [Sinopse], [Capa]) VALUES" +
                " (@Titulo, @Genero, @Autor, @Sinopse, @Capa)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Capa", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Capa", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Livro] SET [Titulo] = @Titulo, [Genero] = @Genero, [Autor] = @Autor" +
                ", [Sinopse] = @Sinopse, [Capa] = @Capa WHERE (([id] = @Original_id))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Capa", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Capa", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Titulo, Genero, Autor, Sinopse, Capa FROM dbo.Livro";
        ...
        public virtual int Insert(string Titulo, string Genero, string Autor, string Sinopse, string Capa) {
            if ((Titulo == null)) {
            ...
            if ((Sinopse == null)) {
                throw new global::System.ArgumentNullException("Sinopse");
            }
            else {
            ...
            if ((Capa == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[4].Value = ((string)(Capa));
            }
        ...
        public virtual int Update(string Titulo, string Genero, string Autor, string Sinopse, string Capa, int Original_id) {
            if ((Titulo == null)) {
                throw new global::System.ArgumentNullException("Titulo");
            }
            else {
            ...
            if ((Capa == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[4].Value = ((string)(Capa));
            }
